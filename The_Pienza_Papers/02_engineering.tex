\phaseportada{PHASE 2}{Data Engineering \& Architecture}{
    % Tech Stack
    Python (Pandas, SciPy), SQLite, Google Apps Script, OSMnx, Advanced Regex, Red Gate Data Modeler (Vertabelo).
}{
    % Core Challenge
    Taming the high-entropy chaos of generative OCR outputs and systemic geospatial corruption to build a structurally sound, temporally-firewalled database.
}{
    % Key Insight
    Decisions do not exist in a vacuum. To accurately clone an agent's policy, the data must capture the "internal state" of the session—accumulated sunk costs, shift progression, and fatigue—without allowing future data to leak into past decisions.
}{
    % Operational Outcome
    The deployment of a "Tabula Rasa" idempotent ETL pipeline, forging the definitive "Golden Link" between fragmented visual telemetry and official bank ledgers to crystallize the \texttt{pienza.db} Golden Master.
}
\section{Phase 2: Data Engineering \& Architecture}
...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/fig_sf_buffer.png}
         \caption{Ave. Santa Fe: Default Centroid}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/fig_sf_linear.png}
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/fig_condesa_buffer.png}
         \caption{Ave. Mexico: Default Centroid}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/fig_condesa_linear.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Pienza_ERD.png}
