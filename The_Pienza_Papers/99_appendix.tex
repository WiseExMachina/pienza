...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/fig_tuning_radiography.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/fig_confusion_matrix_2.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/fig_layer1_matrix.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/fig_nuanced_dna.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/fig_layer2_matrix.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/fig_layer2_shap_dna.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/fig_shadow_mode_results.png} 
