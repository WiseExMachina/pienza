\phaseportada{PHASE 3}{Exploratory Analysis \& Causal Inference}{
    % Tech Stack
    Optimal Stopping Theory, Net Expected Value (VEN), OLS \& Polynomial Regression, LOWESS Smoothing, Heteroscedasticity Analysis.
}{
    % Core Challenge
    Defining a mathematically rational search time via behavioral economics, and modeling the inelastic threshold of platform payouts through causal inference.
}{
    % Key Insight
    Search time is not merely friction; it is a depreciating financial derivative with a strict 9-minute rationality cap. Concurrently, the platform's pricing algorithm enforces an inelastic "Integrity Buffer" to explicitly neutralize the moral hazard of intentional driver delay.
}{
    % Operational Outcome
    The derivation of the dimensionless Market Quality Index (MQI) and the Efficient Frontier, establishing the hard mathematical boundaries of agent rationality required for the transition into Machine Learning.
}

\section{Phase 3: Exploratory Analysis \& Causal Inference}
...
\begin{enumerate}[noitemsep, topsep=3pt]
    ...
    \item \textbf{EPH Complete:}\footnote{For non-completed offers, values were imputed using session-specific rolling averages, adhering to a strict \textit{no-look-ahead} protocol to prevent temporal data leakage.} The final metric including \textit{Total Deadhead} (search time, pickup, and passenger wait times). 
\end{enumerate}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/fig_profitability_funnel.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/fig_median_yield_by_friction.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/fig_transmutation.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/fig_mqi_volatility.png} 
...
As shown in Figure \ref{fig:mqi_volatility}, the agent operates within a non-stationary environment. Certain sessions (indicated in green) represent high-quality market states, while others (in red) signify economic scarcity.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/fig_strategic_quadrants.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/fig_playbook_ven_prob.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/fig_efficient_frontier.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/Phase1_Stability_Audit.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/Heteroscedasticity_Audit.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Reality_Check_Matrix.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/Response_Curve_Audit.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/Quadratic_Risk_Model.png}
