...
st.markdown("""
    <h4 style='color: #21918c; font-weight: 300 !important; margin-top: -10px;'>
        A Digital Twin, From Field Acquisition to Generative Simulation
    </h4>
    """, unsafe_allow_html=True)
...
<b>Project Pienza</b> is an independent, end-to-end Data Science research initiative that captures the proven—yet tacit—heuristics of street-level ride-hailing in Mexico City.
<br><br>
Engineered to overcome survivorship bias by digitizing the agent's full decision boundaries over a 6-week field acquisition window, Pienza executes the entire data lifecycle: from raw extraction and feature engineering, through schema reconciliation (pienza.db), to causal audits, supervised learning, and an NLP Transformer.
<br><br>
